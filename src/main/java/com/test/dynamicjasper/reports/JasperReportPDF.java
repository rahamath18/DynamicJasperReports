...
public class JasperReportPDF {
	...
	private static void build() {
		try {
			...
			JasperPdfExporterBuilder PdfExporter = export.pdfExporter("D:/EmployeeDetailsReport" + ".pdf");
	...
	private static JasperReportBuilder getReportColumns() {
		...
		File comapnyLogo = new File(
				new JasperReportPDF().getClass().getClassLoader().getResource("report/logo.png").getFile());
